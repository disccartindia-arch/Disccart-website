...
const SOCIAL_LINKS = {
  whatsapp: 'https://whatsapp.com/channel/0029Vb6dtO41t90dZb1BnB3K',
  telegram: 'https://t.me/disccart',
  instagram: 'https://www.instagram.com/disccart?igsh=MWlqdjVqcXd6cmx0OA=='
};
...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-white py-12 mt-8" data-testid="footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-4 max-w-md">
              India's smartest deal discovery platform. Find verified coupons, exclusive deals, and save money on every purchase.
            </p>
            ...
            <div className="flex gap-4">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-[#0088cc] flex items-center justify-center hover:opacity-90 transition-opacity"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#dc2743] flex items-center justify-center hover:opacity-90 transition-opacity"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
